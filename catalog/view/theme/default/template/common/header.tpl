  ...
  <div class="container">
    ...
    <div id="top-links" class="nav pull-right">
      <ul class="list-inline">
        ...
        <li class="hidden dropdown"><a href="<?php echo $account; ?>" title="<?php echo $text_account; ?>" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <span class="hidden-xs hidden-sm hidden-md"><?php echo $text_account; ?></span> <span class="caret"></span></a>
...
<header>
  <div class="container">
    <div class="row">
      ...
      <div class="hidden col-sm-3"><?php echo $cart; ?></div>
    </div>
  </div>
</header>
<?php if ($categories) { ?>
