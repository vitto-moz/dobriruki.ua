			...
			<div class="card-content">
				...
				<p>
					<?php if ($thumb || $description) { ?>
						<?php if ($thumb) { ?>
							<p><img src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" /></p>
						<?php } ?>
						<?php if ($description) { ?>
					...
					<div class="collection">
						<a class="collection-item" href="<?php echo $compare; ?>"><?php echo $text_compare; ?></a>
					</div>
					<?php if ($categories) { ?>
						<?php if (count($categories) <= 5) { ?>
							<div class="input-field">
								...
								<label><?php echo $text_refine; ?></label>
								</div>
							<?php } else { ?>
								<div class="input-field">
									<select onchange="location = this.value;">
